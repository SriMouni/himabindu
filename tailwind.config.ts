...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans:    ["var(--font-body)", "Urbanist", "Inter", "Arial", "sans-serif"],
        heading: ["var(--font-heading)", "Georgia", "serif"],
        body:    ["var(--font-body)", "Urbanist", "Inter", "Arial", "sans-serif"],
        label:   ["var(--font-label)", "Urbanist", "Inter", "Arial", "sans-serif"],
      },
    },
  },
  plugins: [],
